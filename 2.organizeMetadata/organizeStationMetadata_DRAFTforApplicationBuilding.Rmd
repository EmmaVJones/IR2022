...
This dataset is the final data sent out by Roger in March 2021 prior for the official start of the assessment.
...
Change of plans, just include organized 2019-2020 citmon/nonagency data.

```{r}
library(naniar) # for replacing "NULL" with NA
source('addInCitMonData.R')
```
...
AUlookup <- read_csv('data/AUlookupTable/20210428_0000_AUlookup.csv')#'data/AUlookupTable/20201013_130553_AUlookup.csv')
```
...
#write.csv(filter(stationsTable2022begin, is.na(ID305B_1) & REGION %in% c('CO', "TRO")), 'forKristieAU.csv', row.names = F)
```
...
write.csv(stationsTable2022begin, 'processedStationData/stationsTable2022begin_CitmonJames.csv', row.names = F)
```
...
#pin(conventionals2022IRfinalWithSecchi_CitmonJames, description = "Final 2022IR conventionals dataset from Roger Stewart _CitmonJames", board = "rsconnect")
...
#pin(conventionals_distinct_final_CitmonJames, description = "Final 2022IR conventionals distinct stations from Roger Stewart _CitmonJames", board = "rsconnect")
...
#pin(stations2020IR_sf_final_CitmonJames, description = "Final 2020IR stations from Cleo Baker _CitmonJames", board = "rsconnect")
...
WQSlookup <- read_csv('data/WQSlookupTable/20210428_0000_WQSlookup.csv')#'data/WQSlookupTable/20210401_0001_WQSlookup.csv')#read_csv('data/WQSlookupTable/20201207_092616_WQSlookup.csv')

...
conventionals2022IRdraftWithSecchi <- conventionals
...
# Pin data
pin(conventionals2022IRdraftWithSecchi, description = "DRAFT 2022IR conventionals dataset from Roger Stewart", board = "rsconnect")

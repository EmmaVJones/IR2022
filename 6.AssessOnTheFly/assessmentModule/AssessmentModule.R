...
assessment <- function(input,output,session, multistationFieldDataUserFilter, multistationAnalyteDataUserFilter, 
                       WQM_Stations_Filter, multistationSelection, VSCIresults, WQSlookup){
  ns <- session$ns
